              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3 border-b border-gray-200 pb-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-600 mt-1">Claritas est etiam processus dynamicus</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 border-b border-gray-200 pb-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-600 mt-1">1234567890</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 border-b border-gray-200 pb-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-600 mt-1">furniture@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
